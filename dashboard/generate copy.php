...
">
                    ...
                    <div class="tab-pane fade" id="nav-signatures" role="tabpanel" aria-labelledby="nav-signatures-tab">
                        <div class="mb-3">
                            <label for="sign_panitia" class="form-label">Nama 1 :</label>
                            <input type="text" class="form-control" id="nama_1" name="nama_1" required>
                        </div>
                        <div class="mb-3">
                            <label for="sign_ketua" class="form-label">Nama 2:</label>
                            <input type="text" class="form-control" id="nama_2" name="nama_2" required>
                        </div>
                        <div class="mb-3">
                            <label for="sign_panitia" class="form-label">Jabatan 1 :</label>
                            <input type="text" class="form-control" id="jabatan_1" name="jabatan_1" required>
                        </div>
                        <div class="mb-3">
                            <label for="sign_ketua" class="form-label">Jabatan 2 :</label>
