  ...
  <ul class="navbar-nav navbar-right">
    <li>
      ...
      >
        ...
        />
        <div class="d-sm-none d-lg-inline-block">Hai, Admin</div></a
      >
    </li>
  </ul>
</nav>
    ...
    <ul class="sidebar-menu">
      ...
      <li>
        <a class="nav-link" href="/admin/sertifikat"
          ><i class="fas fa-th"></i> <span>Template Sertifikat</span></a
        >
      </li>
      <li>
        <a class="nav-link" href="blank.html"
          ><i class="far fa-user"></i> <span>Pengguna</span></a
        >
      </li>
    </ul>
